...
export type MessageEntity = {
     ...
     */
    type: 'mention' | 'hashtag' | 'cashtag' | 'bot_command' | 'email' | 'phone_number' | 'bold' | 'italic' | 'underline' | 'strikethrough' | 'spoiler' | 'blockquote' | 'expandable_blockquote' | 'code' | 'text_link';
} | {
    /**
     * Type of the entity.
     * “url” (https://telegram.org),
